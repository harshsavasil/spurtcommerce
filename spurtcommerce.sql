...
--
-- Host: localhost
-- Generation Time: Sep 03, 2019 at 08:50 PM
...
(1, 352, 'demo@gmail.com', 'demo', '::1', '2019-09-03 17:32:23', NULL, NULL, NULL),
(2, 352, 'demo@gmail.com', 'demo', '::1', '2019-09-03 20:03:45', NULL, NULL, NULL);
...
INSERT INTO `order` (`order_id`, `customer_id`, `currency_id`, `shipping_zone_id`, `payment_zone_id`, `shipping_country_id`, `payment_country_id`, `invoice_no`, `invoice_prefix`, `order_prefix_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `shipping_firstname`, `shipping_lastname`, `shipping_company`, `shipping_address_1`, `shipping_address_2`, `shipping_city`, `shipping_postcode`, `shipping_country`, `shipping_zone`, `shipping_address_format`, `shipping_method`, `payment_firstname`, `payment_lastname`, `payment_company`, `payment_address_1`, `payment_address_2`, `payment_city`, `payment_postcode`, `payment_country`, `payment_zone`, `payment_address_format`, `comment`, `total`, `reward`, `order_status_id`, `affiliate_id`, `commision`, `currency_code`, `currency_value`, `ip`, `order_name`, `is_active`, `created_by`, `modified_by`, `created_date`, `modified_date`) VALUES
(1, 352, NULL, NULL, NULL, NULL, NULL, 'INV001', 'SPU', 'SPU-201909031', NULL, NULL, 'demo@gmail.com', '8428524613', NULL, 'demo', 'user', '', 'nehru nagar', 'chrompet', 'chennai', '7667889', 'India', 'TN', '', NULL, 'demo', 'user', '', 'nehru nagar', 'chrompet', 'chennai', '7667889', '99', 'TN', '', NULL, '360.00', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, '2019-09-03 17:33:24', '2019-09-03 17:33:24'),
(2, 352, NULL, NULL, NULL, NULL, NULL, 'INV002', 'SPU', 'SPU-201909032', NULL, NULL, 'demo@gmail.com', '8428524613', NULL, 'demo', 'user', '', 'nehru nagar', 'chrompet', 'chennai', '600042', 'India', 'Tamil Nadu', '', NULL, 'demo', 'user', '', 'nehru nagar', 'chrompet', 'chennai', '600042', '99', 'Tamil Nadu', '', NULL, '780.00', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, '2019-09-03 20:05:19', '2019-09-03 20:05:19');
...
INSERT INTO `order_product` (`order_product_id`, `product_id`, `order_id`, `name`, `product_price`, `model`, `quantity`, `trace`, `total`, `tax`, `is_active`, `created_by`, `modified_by`, `created_date`, `modified_date`) VALUES
(1, 542, 1, 'DZert Soft Plush Fabric Multicolour Micky Printed School Bag for Baby Boys and Girls', '360.00', 'DZert Soft Plush Fabric Multicolour Micky Printed School Bag for Baby Boys and Girls', 1, NULL, '360.00', NULL, NULL, NULL, NULL, '2019-09-03 17:33:24', NULL),
(2, 555, 2, 'BEEVEE Men\'s 100% Cotton Solid Khaki Fixed Waist Turn Ups and Detachable Cargo with Belt', '780.00', '', 1, NULL, '780.00', NULL, NULL, NULL, NULL, '2019-09-03 20:05:19', NULL);
...
(1, 1, NULL, NULL, NULL, '360.00', NULL, NULL, NULL, NULL, '2019-09-03 17:33:24', NULL),
(2, 2, NULL, NULL, NULL, '780.00', NULL, NULL, NULL, NULL, '2019-09-03 20:05:19', NULL);
...
(65, 1, 'admin@spurtcart.com', '$2b$10$caXJ3hkFuDyBhI/t21wvv.GBDbSYd66HMt4xALjv9JDolXLPUuz.K', 'admin', 'user', 'admin@spurtcart.com', 'Img_1567002487693.jpeg', 'user/', NULL, NULL, 'aaa', 9751218216, 1, '2019-08-27 05:39:53', '2019-09-03 20:05:58', NULL, NULL, 0);
...
--
ALTER TABLE `category_path`
  MODIFY `category_path_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=592;
--
...
--
ALTER TABLE `product_to_category`
  MODIFY `product_to_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4312;
--
